...
const RUN_EVENT_ICONS: Record<string, { icon: string; label: string; color: string }> = {
    ...
    'step:planned':     { icon: '📐', label: '规划中', color: '#a855f7' },
    'step:assigned':    { icon: '📌', label: '已分配', color: '#3b82f6' },
    'step:in_progress': { icon: '⚡', label: '执行中', color: '#22c55e' },
    'step:submitted_for_review': { icon: '🔍', label: '提交审核', color: '#f59e0b' },
    ...
    'step:info':        { icon: 'ℹ️', label: '步骤信息', color: '#64748b' },
