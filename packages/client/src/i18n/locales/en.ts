export default {
  ...
  groupChat: {
    ...
    agentSettingsHint: 'These settings only apply within this room and do not affect the global Hermes profile.',
    overrideBasic: 'Basic',
    overrideModel: 'Model',
    overrideModelPlaceholder: 'Leave empty to use profile default',
    overrideProvider: 'Provider',
    overrideProviderPlaceholder: 'Select provider (required for custom models)',
    overrideSkills: 'Skills',
    overrideSkillsAllowList: 'Skills Allow List',
    overrideSkillPlaceholder: 'Type skill name and press Enter',
    overrideContext: 'Context',
    overrideSystemPrompt: 'System Prompt',
    overrideSystemPromptPlaceholder: 'Leave empty to use profile default',
    overrideContextEnabled: 'Context Enabled',
    overrideInherit: 'Empty = inherit room / default',
  },
