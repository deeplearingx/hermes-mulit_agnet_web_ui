export default {
  ...
  groupChat: {
    ...
    agentSettingsHint: '以下配置仅在本房间内生效，不影响 Hermes profile 全局配置。',
    overrideBasic: '基础配置',
    overrideModel: '模型',
    overrideModelPlaceholder: '留空则使用 profile 默认模型',
    overrideProvider: 'Provider',
    overrideProviderPlaceholder: '选择 Provider（自定义模型必填）',
    overrideSkills: 'Skills',
    overrideSkillsAllowList: '技能白名单',
    overrideSkillPlaceholder: '输入技能名称后按 Enter',
    overrideContext: '上下文',
    overrideSystemPrompt: '系统提示词',
    overrideSystemPromptPlaceholder: '留空则使用 profile 默认提示词',
    overrideContextEnabled: '启用上下文',
    overrideInherit: '留空则继承房间/默认配置',
  },
