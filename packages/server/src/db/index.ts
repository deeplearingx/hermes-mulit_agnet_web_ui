...
const DB_PATH = isTest
  ...
  : resolve(DB_DIR, 'hermes-web-ui.db')
const JSON_PATH = isTest
  ? resolve(DB_DIR, `hermes-web-ui-vitest-${getVitestWorkerId()}.json`)
  : resolve(DB_DIR, 'hermes-web-ui.json')
